/**
 * Chapter 7: SmartArc.java
 * Extends Java's Arc2D.Double class, adding the capabilities to
...
// Fall 2012
// Steven Gerhard
// An arc that knows its color
// rotation, and how to draw itself
public class SmartArc extends java.awt.geom.Arc2D.Double {
    ...
    public SmartArc (double aStart, double anExtent,
		     int aType, java.awt.Color aColor) {
